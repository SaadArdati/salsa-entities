...
Map<String, dynamic> _$EditSuggestionToJson(EditSuggestion instance) => <String, dynamic>{
...
SnippetTrack _$SnippetTrackFromJson(Map<String, dynamic> json) {
  return $checkedNew('SnippetTrack', json, () {
    final val = SnippetTrack(
      ...
      waveform: $checkedConvert(json, 'waveform', (v) => const ByteArrayJsonConverter().fromJson(v as List)),
      clipEnd: $checkedConvert(json, 'clipEnd', (v) => v as int),
      clipStart: $checkedConvert(json, 'clipStart', (v) => v as int),
...
Map<String, dynamic> _$SnippetTrackToJson(SnippetTrack instance) => <String, dynamic>{
      'id': instance.id,
...
ScoredSnippetTrack _$ScoredSnippetTrackFromJson(Map<String, dynamic> json) {
  return $checkedNew('ScoredSnippetTrack', json, () {
    ...
    $checkedConvert(json, 'waveform', (v) => val.waveform = const ByteArrayJsonConverter().fromJson(v as List));
    return val;
  });
}

Map<String, dynamic> _$ScoredSnippetTrackToJson(ScoredSnippetTrack instance) => <String, dynamic>{
      'id': instance.id,
      'duration': instance.duration,
      'clipStart': instance.clipStart,
      'clipEnd': instance.clipEnd,
...
FullTrack _$FullTrackFromJson(Map<String, dynamic> json) {
  return $checkedNew('FullTrack', json, () {
    final val = FullTrack(
      ...
      clipEnd: $checkedConvert(json, 'clipEnd', (v) => v as int),
      blurHash: $checkedConvert(json, 'blurHash', (v) => v as String),
      publishedAt: $checkedConvert(json, 'publishedAt', (v) => v == null ? null : DateTime.parse(v as String)),
      geniusSuggestions: $checkedConvert(json, 'geniusSuggestions',
          (v) => (v as List)?.map((e) => e == null ? null : GeniusTrack.fromJson(e as Map<String, dynamic>))?.toList()),
      editSuggestions: $checkedConvert(
          json,
          'editSuggestions',
          (v) => (v as Map<String, dynamic>)?.map(
                (k, e) => MapEntry(k, e == null ? null : EditSuggestion.fromJson(e as Map<String, dynamic>)),
              )),
      ...
      ngrams: $checkedConvert(json, 'ngrams', (v) => (v as List)?.map((e) => e as String)?.toList()),
...
Map<String, dynamic> _$FullTrackToJson(FullTrack instance) => <String, dynamic>{
      ...
      'fullCoverURL': instance.fullCoverURL,
      'blurHash': instance.blurHash,
      'geniusSuggestions': instance.geniusSuggestions?.map((e) => e?.toJson())?.toList(),
      'editSuggestions': instance.editSuggestions?.map((k, e) => MapEntry(k, e?.toJson())),
...
Map<String, dynamic> _$GeniusTrackToJson(GeniusTrack instance) => <String, dynamic>{
...
Playlist _$PlaylistFromJson(Map<String, dynamic> json) {
  return $checkedNew('Playlist', json, () {
    final val = Playlist(
      ...
      trackIDs: $checkedConvert(json, 'trackIDs', (v) => (v as List)?.map((e) => e as String)?.toList()),
      tracks: $checkedConvert(
          json,
          'tracks',
          (v) =>
              (v as List)?.map((e) => e == null ? null : SnippetTrack.fromJson(e as Map<String, dynamic>))?.toList()),
      id: $checkedConvert(json, 'id', (v) => v as String),
      ownerID: $checkedConvert(json, 'ownerID', (v) => v as String),
      ownerName: $checkedConvert(json, 'ownerName', (v) => v as String),
      whitelistedUserIDs:
          $checkedConvert(json, 'whitelistedUserIDs', (v) => (v as List)?.map((e) => e as String)?.toList()),
      accessRequests: $checkedConvert(json, 'accessRequests', (v) => (v as List)?.map((e) => e as String)?.toList()),
      listens: $checkedConvert(json, 'listens', (v) => v as int),
    );
    return val;
  });
...
ChaChaUserSnippet _$ChaChaUserSnippetFromJson(Map<String, dynamic> json) {
  return $checkedNew('ChaChaUserSnippet', json, () {
    final val = ChaChaUserSnippet(
      ...
      profilePicture: $checkedConvert(json, 'profilePicture', (v) => v as String),
    );
    return val;
  });
}

Map<String, dynamic> _$ChaChaUserSnippetToJson(ChaChaUserSnippet instance) => <String, dynamic>{
      'id': instance.id,
  ...
  return $checkedNew('ChaChaUser', json, () {
    final val = ChaChaUser(
      ...
      tracks: $checkedConvert(
          ...
          (v) =>
              (v as List)?.map((e) => e == null ? null : SnippetTrack.fromJson(e as Map<String, dynamic>))?.toList()),
      playlists: $checkedConvert(json, 'playlists',
          (v) => (v as List)?.map((e) => e == null ? null : Playlist.fromJson(e as Map<String, dynamic>))?.toList()),
      trackIDs: $checkedConvert(json, 'trackIDs', (v) => (v as List)?.map((e) => e as String)?.toList()),
      playlistIDs: $checkedConvert(json, 'playlistIDs', (v) => (v as List)?.map((e) => e as String)?.toList()),
      friendRequests: $checkedConvert(
          json,
          'friendRequests',
          (v) => (v as List)
              ?.map((e) => e == null ? null : ChaChaUserSnippet.fromJson(e as Map<String, dynamic>))
              ?.toList()),
      friends: $checkedConvert(
          ...
          (v) => (v as List)
              ?.map((e) => e == null ? null : ChaChaUserSnippet.fromJson(e as Map<String, dynamic>))
              ?.toList()),
      friendIDs: $checkedConvert(json, 'friendIDs', (v) => (v as List)?.map((e) => e as String)?.toList()),
      blockedUserIDs: $checkedConvert(json, 'blockedUserIDs', (v) => (v as List)?.map((e) => e as String)?.toList()),
    );
    return val;
  });
}

Map<String, dynamic> _$ChaChaUserToJson(ChaChaUser instance) => <String, dynamic>{
      'id': instance.id,
      'displayName': instance.displayName,
      'profilePicture': instance.profilePicture,
      'tracks': instance.tracks?.map((e) => e?.toJson())?.toList(),
